    ...
    <div className="bg-gray-50 overflow-x-hidden min-h-screen pb-4">
      <div className="px-5 pt-4 space-y-4">
          ...
          <CardContent className="p-5">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs text-gray-600">TelÃ©fono</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs text-gray-600">DirecciÃ³n de Residencia</p>
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-gray-700 px-1">InformaciÃ³n MÃ©dica</h3>
          <Card className="bg-white border-0">
        ...
        <Card className="bg-white border-0">
          <CardContent className="p-5">
            ...
            <div className="space-y-3">
              ...
              <div>
                <p className="text-xs text-gray-600">TelÃ©fono de Contacto</p>
