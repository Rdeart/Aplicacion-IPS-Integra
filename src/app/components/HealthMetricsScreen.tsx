    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white p-6 overflow-x-hidden">
      ...
      <div className="flex items-center justify-between mb-8 pt-4">
        ...
        <div className="flex items-center text-gray-900">
          ...
          <h1 className="text-lg font-medium">MÃ©tricas de Salud Hoy</h1>
        </div>
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="mt-8 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900">Resumen del dÃ­a</h3>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Zona cardÃ­aca</span>
              <span className="font-medium text-blue-600">Normal</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Calidad del sueÃ±o</span>
              <span className="font-medium text-purple-600">Excelente</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Balance calÃ³rico</span>
        ...
        <div className="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-4 border border-blue-100">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium text-blue-900 mb-1">Consejo del dÃ­a</h4>
              <p className="text-sm text-blue-700">
                Â¡Excelente progreso! Intenta caminar 10 minutos mÃ¡s para alcanzar tu meta diaria de pasos.
              </p>
            </div>
          </div>
        </div>
