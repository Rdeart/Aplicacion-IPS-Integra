...
export function HealthSummaryDemo({ onBack }: HealthSummaryDemoProps) {
  // Diferentes escenarios de mÃ©tricas para demostrar la IA
  const scenarios = [
    {
      name: 'Usuario Saludable',
      description: 'Todas las mÃ©tricas en rango normal',
      metrics: {
        steps: 10500,
        heartRate: 68,
        sleep: 8.2,
    ...
    },
    {
      ...
      description: 'Baja actividad fÃ­sica y sueÃ±o insuficiente',
      metrics: {
        steps: 4200,
        heartRate: 75,
        sleep: 5.5,
    ...
    },
    {
      ...
      description: 'MÃºltiples mÃ©tricas fuera de rango',
      metrics: {
        steps: 3000,
        heartRate: 110,
        sleep: 4.5,
    ...
    {
      name: 'Usuario Activo',
      description: 'Alta actividad pero ritmo cardÃ­aco elevado',
      metrics: {
        steps: 15000,
        heartRate: 105,
        sleep: 7.8,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-6">
      ...
      <div className="flex items-center justify-between mb-6 pt-4">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600">AnÃ¡lisis inteligente de mÃ©tricas</p>
        </div>
      ...
      <div className="max-w-2xl mx-auto space-y-6">
          ...
          <CardContent>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  <span className="text-gray-500">SueÃ±o:</span>
                  <span className="font-medium ml-2">{currentMetrics.sleep}h</span>
                </div>
                <div>
                  <span className="text-gray-500">CalorÃ­as:</span>
        ...
        {/* AnÃ¡lisis Detallado de IA */}
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <RefreshCw className="h-5 w-5 text-purple-600" />
              AnÃ¡lisis de Inteligencia Artificial
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="font-medium text-gray-700">PuntuaciÃ³n de Salud</span>
            ...
            {healthAnalysis.issues.length === 0 && (
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-green-900">Â¡Excelente estado de salud!</span>
                </div>
                <p className="text-sm text-green-700">
                  Todas tus mÃ©tricas estÃ¡n en rangos Ã³ptimos. MantÃ©n estos hÃ¡bitos saludables.
                </p>
              </div>
            )}
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>LÃ³gica de IA Implementada</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-3 text-sm">
              <div>
                ...
                <ul className="space-y-1 text-gray-600 ml-4">
                  <li>â€¢ <strong>Pasos:</strong> {">"} 8,000 pasos diarios</li>
                  <li>â€¢ <strong>Pulso:</strong> 60-100 bpm en reposo</li>
                  <li>â€¢ <strong>SueÃ±o:</strong> {">"} 7 horas por noche</li>
                  <li>â€¢ <strong>CalorÃ­as:</strong> 80%-120% de la meta personal</li>
                </ul>
              </div>
              
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Algoritmo de DecisiÃ³n:</h4>
                <ul className="space-y-1 text-gray-600 ml-4">
                  <li>â€¢ <strong>Estable:</strong> Todas las mÃ©tricas en rango normal</li>
                  <li>â€¢ <strong>Mejorable:</strong> 1-2 mÃ©tricas fuera de rango</li>
                  <li>â€¢ <strong>Alerta:</strong> 3+ mÃ©tricas fuera de rango</li>
                </ul>
              </div>
            </div>
          </CardContent>
