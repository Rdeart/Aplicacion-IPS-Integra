    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[300px] p-8 text-center">
          ...
          <h2 className="text-gray-900 mb-2">Algo saliÃ³ mal</h2>
          <p className="text-sm text-gray-500 mb-6 max-w-xs">
            OcurriÃ³ un error inesperado. Puedes intentar de nuevo o volver al inicio.
          </p>
      ...
      return (
        <div className="flex flex-col items-center justify-center h-full min-h-screen bg-gray-50 p-8 text-center">
          ...
          <p className="text-sm text-gray-500 mb-8 max-w-xs leading-relaxed">
            Esta secciÃ³n presentÃ³ un error. Tu informaciÃ³n estÃ¡ segura.
          </p>
          {import.meta.env.DEV && this.state.error && (
