...
export function DashboardScreen({ 
  ...
  const getNotificationBadge = (type: string) => {
    switch (type) {
      ...
      case 'authorization':
        return { bg: 'bg-green-100', text: 'text-green-700', label: 'AutorizaciÃ³n' };
      case 'result':
      ...
      default:
        return { bg: 'bg-gray-100', text: 'text-gray-700', label: 'NotificaciÃ³n' };
    }
  };
  ...
  const newsArticles: NewsArticle[] = [
    {
      ...
      content: `En Integra IPS ofrecemos atenciÃ³n mÃ©dica integral con los mÃ¡s altos estÃ¡ndares de calidad para ti y tu familia.

Nuestros servicios incluyen:
â€¢ Medicina General y Especializada
â€¢ Laboratorio ClÃ­nico certificado
â€¢ ImÃ¡genes DiagnÃ³sticas
â€¢ Programas de PrevenciÃ³n y PromociÃ³n
â€¢ Telemedicina 24/7
â€¢ AtenciÃ³n prioritaria para usuarios EPS

Tu bienestar es nuestro compromiso. ConfÃ­a en Integra IPS.`,
      date: '2 de Enero, 2025',
      author: 'Integra IPS'
    },
    {
      id: '2',
      title: 'Nuevas Especialidades MÃ©dicas Disponibles',
      ...
      content: `Â¡Gran noticia! Ahora contamos con nuevas especialidades mÃ©dicas para brindarte la mejor atenciÃ³n.

Nuevas especialidades disponibles:
â€¢ CardiologÃ­a - Cuidado integral del corazÃ³n
â€¢ OtorrinolaringologÃ­a - Salud auditiva y respiratoria
â€¢ FonoaudiologÃ­a - Terapias de lenguaje y audiciÃ³n
â€¢ PsicologÃ­a ClÃ­nica - Bienestar mental
â€¢ Terapia FÃ­sica - RehabilitaciÃ³n profesional
â€¢ NutriciÃ³n - Planes alimenticios personalizados

Agenda tu cita ahora mismo a travÃ©s de nuestra app o llamando a nuestras lÃ­neas de atenciÃ³n. Estamos aquÃ­ para cuidarte.`,
      date: '28 de Diciembre, 2024',
      author: 'Integra IPS'
    },
    {
      id: '3',
      title: 'TecnologÃ­a al servicio de tu salud',
      subtitle: '',
      ...
      content: `La telemedicina revoluciona la atenciÃ³n en salud. Consulta con especialistas desde la comodidad de tu hogar.

Servicios disponibles:
â€¢ Consultas mÃ©dicas virtuales 24/7
â€¢ Especialistas certificados
â€¢ Recetas electrÃ³nicas
â€¢ Seguimiento personalizado
â€¢ Acceso a historia clÃ­nica digital

La salud digital estÃ¡ aquÃ­ para quedarse. Aprovecha la tecnologÃ­a para cuidar mejor de ti y los tuyos.

Â¡Agenda tu primera consulta virtual hoy!`,
      date: '25 de Diciembre, 2024',
      author: 'Dr. Carlos Mendoza'
    },
    {
      id: '4',
      title: 'PrevenciÃ³n: Tu mejor inversiÃ³n en salud',
      subtitle: '',
...
ExÃ¡menes recomendados segÃºn tu edad:
â€¢ 20-30 aÃ±os: Hemograma, glicemia, perfil lipÃ­dico
â€¢ 30-40 aÃ±os: + Examen de tiroides, mamografÃ­a (mujeres)
â€¢ 40-50 aÃ±os: + Pruebas cardiovasculares, colonoscopia
â€¢ 50+ aÃ±os: Chequeos completos anuales

Incluidos en tu plan de salud:
âœ“ ExÃ¡menes de laboratorio bÃ¡sicos
âœ“ Consulta mÃ©dica general
âœ“ ValoraciÃ³n de riesgos
âœ“ Plan de prevenciÃ³n personalizado

No esperes a sentir sÃ­ntomas. La prevenciÃ³n es tu mejor aliada.`,
    ...
    },
    {
      ...
      content: `Tu salud mental es tan importante como tu salud fÃ­sica. No estÃ¡s solo, estamos aquÃ­ para ayudarte.

Servicios de apoyo psicolÃ³gico:
â€¢ Consulta con psicologÃ­a
â€¢ Terapia individual y grupal
â€¢ Programas de manejo de estrÃ©s
â€¢ Apoyo en crisis 24/7
â€¢ Talleres de mindfulness

SeÃ±ales de que podrÃ­as necesitar ayuda:
- Cambios en el sueÃ±o o apetito
- PÃ©rdida de interÃ©s en actividades
- Dificultad para concentrarte
- Sentimientos de tristeza persistente
- Ansiedad o preocupaciÃ³n excesiva

Recuerda: Pedir ayuda es un signo de fortaleza, no de debilidad.

Tu bienestar emocional es nuestra prioridad. ContÃ¡ctanos hoy.`,
      date: '15 de Diciembre, 2024',
      author: 'Psic. MarÃ­a Torres'
    }
  ];
  ...
  const upcomingAppointments = [
    {
      id: '1',
      specialty: 'OtorrinolaringologÃ­a',
  ...
  const specializedServices: SpecializedService[] = [
    {
      ...
      description: 'DiagnÃ³stico, tratamiento y seguimiento integral de las enfermedades de oÃ­do, nariz y garganta.',
      icon: 'ear',
      category: 'Especialidad MÃ©dica',
      detailedDescription: 'La otorrinolaringologÃ­a es la especialidad mÃ©dica que se encarga del diagnÃ³stico, tratamiento y seguimiento integral de las enfermedades de oÃ­do, nariz, garganta y estructuras relacionadas de cabeza y cuello.',
      whenToConsult: [
        'Dolor de oÃ­do persistente o infecciones recurrentes',
        'PÃ©rdida de audiciÃ³n o zumbidos en los oÃ­dos',
      ...
      whatIncludes: [
        ...
        'DiagnÃ³stico y plan de tratamiento personalizado'
      ],
      professionals: [
    ...
    },
    {
      ...
      detailedDescription: 'La otologÃ­a es la subespecialidad enfocada en el diagnÃ³stico y tratamiento mÃ©dico y quirÃºrgico de las enfermedades del oÃ­do y estructuras relacionadas.',
      whenToConsult: [
        'PÃ©rdida auditiva sÃºbita o progresiva',
      ...
      whatIncludes: [
        ...
        'EvaluaciÃ³n de funciÃ³n auditiva',
    ...
    },
    {
      id: '3',
      title: 'AudiologÃ­a',
      description: 'DiagnÃ³stico, tratamiento y rehabilitaciÃ³n de los trastornos auditivos y del equilibrio.',
      icon: 'volume',
      category: 'Ciencias de la Salud',
      detailedDescription: 'La audiologÃ­a es la disciplina de las ciencias de la salud que se dedica al estudio, diagnÃ³stico, tratamiento y rehabilitaciÃ³n de los trastornos auditivos y del equilibrio.',
      whenToConsult: [
        'Dificultad para escuchar conversaciones',
        'Necesidad de subir el volumen constantemente',
        'PÃ©rdida de equilibrio o mareos frecuentes',
        'EvaluaciÃ³n auditiva preventiva'
      ],
      whatIncludes: [
    ...
    },
    {
      ...
      description: 'EvaluaciÃ³n, diagnÃ³stico y rehabilitaciÃ³n de trastornos de comunicaciÃ³n, voz, habla, lenguaje y degluciÃ³n.',
      icon: 'message',
      category: 'RehabilitaciÃ³n',
      detailedDescription: 'La fonoaudiologÃ­a se especializa en la evaluaciÃ³n, diagnÃ³stico y rehabilitaciÃ³n de trastornos de la comunicaciÃ³n, voz, habla, lenguaje y degluciÃ³n.',
      whenToConsult: [
      ...
      whatIncludes: [
        'EvaluaciÃ³n fonoaudiolÃ³gica completa',
        'ValoraciÃ³n de habla y lenguaje',
        'EvaluaciÃ³n de la degluciÃ³n',
    ...
    },
    {
      ...
      detailedDescription: 'Nuestro programa especializado en vÃ©rtigo y tinnitus ofrece un manejo integral y multidisciplinario del mareo, la inestabilidad y el zumbido de oÃ­dos.',
      whenToConsult: [
    ...
    },
    {
      ...
      description: 'DiagnÃ³stico, adaptaciÃ³n y soluciones auditivas (audÃ­fonos e implantables).',
      icon: 'headphones',
      ...
      whenToConsult: [
        'PÃ©rdida auditiva que afecta tu vida diaria',
        'Necesidad de audÃ­fonos o reemplazo de los actuales',
        'EvaluaciÃ³n para implantes cocleares'
      ],
      whatIncludes: [
        'EvaluaciÃ³n audiolÃ³gica completa',
        'SelecciÃ³n y adaptaciÃ³n de audÃ­fonos',
        'Pruebas de audÃ­fonos gratuitas',
        'Seguimiento y mantenimiento'
      ],
      professionals: [
        { name: 'Lic. Sandra Ortiz', availability: 'PrÃ³xima disponibilidad: Lun 10:00' }
      ]
    }
  ];
      ...
      <div className="relative overflow-x-hidden">
        ...
        <div className="bg-blue-500 px-5 pb-6 -mt-0">
          ...
          <div className="flex items-center gap-2 text-white mb-2">
            <h2 className="text-2xl font-normal">Â¡Hola, </h2>
        ...
        <div className="p-5 space-y-4">
          ...
          <CardContent className="space-y-2">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-white/90 leading-snug">Dr. Carlos Mendoza - OtorrinolaringologÃ­a</p>
            ...
            {recentResults.map((result) => (
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 leading-snug">{result.type} â€¢ {result.date}</p>
                </div>
          ...
          <EpidemiologicalAlertCard 
            alertMessage="Aumento de casos de dengue en tu zona. MantÃ©n precauciones y elimina criaderos de mosquitos."
