      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-sm space-y-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            {/* Username Field */}
            <div>
              <label htmlFor="login-username" className="sr-only">Usuario o correo electrÃ³nico</label>
              <Input
                id="login-username"
                type="text"
                placeholder="Usuario"
            ...
            <div className="relative">
              <label htmlFor="login-password" className="sr-only">ContraseÃ±a</label>
              <Input
                id="login-password"
          ...
          <div className="text-center space-y-4 pt-8">
            <button
              ...
              aria-label="Iniciar sesiÃ³n con Face ID"
          ...
          <div className="text-center pt-8">
            <button 
              ...
              style={{ color: '#64748b' }}
            >
              Â¿AÃºn no tienes usuario o cuenta?
            </button>
          </div>
          
          {/* Demo Access - Oculto en producciÃ³n, solo para desarrollo */}
          <div className="text-center pt-2">
            <button
              onClick={handleDemoLogin}
              className="text-blue-500 text-sm hover:underline font-medium transition-colors"
            >
              ðŸš€ Acceso Demo (Para pruebas)
            </button>
          </div>
        </div>
      </div>
