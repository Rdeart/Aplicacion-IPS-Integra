...
export function EpidemiologicalAlertCard({ 
  alertMessage = "Aumento de casos de dengue en tu zona. MantÃ©n precauciones.",
  ...
  return (
    <div 
      ...
      `}
    >
      {/* Header con Ã­cono de localizaciÃ³n */}
