...
export function RegisterScreen({ onRegister, onBackToLogin }: RegisterScreenProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!validateStep2()) {
      alert('Por favor completa todos los campos requeridos y verifica que las contraseÃ±as coincidan.');
      return;
    }
    ...
    <div className="min-h-screen bg-white flex flex-col p-6">
      ...
      <div className="flex-1 max-w-sm mx-auto w-full">
        ...
        <h2 className="text-2xl font-light text-center mb-2">
          {step === 1 ? 'InformaciÃ³n Personal' : 'Cuenta y Seguridad'}
        </h2>
        <p className="text-gray-600 text-center mb-8">
          {step === 1 ? 'Completa tus datos bÃ¡sicos' : 'Configura tu acceso'}
        </p>
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Input
                  type="tel"
                  placeholder="TelÃ©fono emergencia"
