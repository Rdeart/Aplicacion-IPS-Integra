...
export function ArticleDetailModal({ article, onClose }: ArticleDetailModalProps) {
  ...
  const handleShare = () => {
    toast.success('Â¡ArtÃ­culo compartido!');
  };

  const handleBookmark = () => {
    toast.success('ArtÃ­culo guardado en favoritos');
  };
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4 mt-6">
                <p className="text-xs text-blue-900 text-center">
                  <strong>Nota:</strong> La informaciÃ³n contenida en este artÃ­culo es de carÃ¡cter informativo y educativo. Siempre consulta con un profesional de la salud para obtener asesoramiento mÃ©dico personalizado.
                </p>
              </div>
            </div>
          </div>
