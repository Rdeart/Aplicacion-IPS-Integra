...
export function AppointmentsScreen({ user, showNewAppointmentForm = false, onDoctorClick }: AppointmentsScreenProps) {
  ...
  const handleConfirmAppointment = () => {
    ...
    toast.success('Â¡Cita agendada exitosamente!', {
      description: 'RecibirÃ¡s confirmaciÃ³n por email y SMS'
    });
  };
    ...
    return (
      ...
      >
              ...
              <CardContent className="p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="text-green-900 mb-1">Â¡Cita confirmada!</h3>
                    <p className="text-sm text-green-800 mb-2">
                      Tu cita ha sido agendada para el {formatDate(selectedDate)} a las {selectedTime} con {selectedDoctor}.
                    </p>
                    <p className="text-xs text-green-700">
                      Te enviaremos un recordatorio 24 horas antes de tu cita por SMS y correo electrÃ³nico.
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <Card className="bg-blue-50 border-blue-200 shadow-sm">
          <CardContent className="p-4">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>â€¢ Las citas se confirman en 24-48 horas</li>
              <li>â€¢ RecibirÃ¡s notificaciÃ³n por SMS y email</li>
              <li>â€¢ Puedes cancelar hasta 4 horas antes</li>
              <li>â€¢ Llega 15 minutos antes de tu cita</li>
              <li>â€¢ Trae tu documento de identidad y carnet de EPS</li>
            </ul>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gray-50 border-gray-200 shadow-sm">
          <CardContent className="p-4">
            <h3 className="text-gray-900 mb-3">Â¿Necesitas ayuda?</h3>
            <div className="space-y-2 text-sm text-gray-700">
              <p>
                <span className="font-medium">TelÃ©fono:</span> +57 (1) 234 5678
              </p>
              <p>
