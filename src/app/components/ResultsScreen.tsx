...
export function ResultsScreen({ user, onDoctorClick }: ResultsScreenProps) {
  ...
  const results = [
    {
      ...
      doctor: 'Dra. Ana Ruiz',
      status: 'available',
      category: 'Examen AudiolÃ³gico',
      description: 'EvaluaciÃ³n de umbrales auditivos por vÃ­a aÃ©rea y Ã³sea',
      results: {
        'OÃ­do Derecho 250Hz': { value: '15', reference: '0-25', unit: 'dB', status: 'normal' },
        'OÃ­do Derecho 500Hz': { value: '10', reference: '0-25', unit: 'dB', status: 'normal' },
        'OÃ­do Derecho 1000Hz': { value: '12', reference: '0-25', unit: 'dB', status: 'normal' },
        'OÃ­do Izquierdo 250Hz': { value: '18', reference: '0-25', unit: 'dB', status: 'normal' },
        'OÃ­do Izquierdo 500Hz': { value: '15', reference: '0-25', unit: 'dB', status: 'normal' },
        'OÃ­do Izquierdo 1000Hz': { value: '14', reference: '0-25', unit: 'dB', status: 'normal' }
      }
    },
    {
      id: '2',
      type: 'AudiologÃ­a',
      name: 'ImpedanciometrÃ­a',
      date: '2024-12-10',
      doctor: 'Dra. Ana Ruiz',
      status: 'available',
      category: 'Examen AudiolÃ³gico',
      description: 'EvaluaciÃ³n de la funciÃ³n del oÃ­do medio',
      summary: 'TimpanometrÃ­a tipo A bilateral. Reflejo estapedial presente en ambos oÃ­dos. FunciÃ³n del oÃ­do medio dentro de parÃ¡metros normales.'
    },
    {
      id: '3',
      type: 'ORL',
      name: 'VideonistagmografÃ­a',
      date: '2024-12-08',
      doctor: 'Dr. Roberto Silva',
      status: 'available',
      category: 'VÃ©rtigo y Equilibrio',
      description: 'EvaluaciÃ³n del sistema vestibular',
      summary: 'Nistagmo espontÃ¡neo ausente. Prueba calÃ³rica bilateral simÃ©trica. Sistema vestibular funcionante bilateralmente. No se evidencian signos de hipofunciÃ³n vestibular.'
    },
    {
      id: '4',
      type: 'AudiologÃ­a',
      name: 'LogoaudiometrÃ­a',
      date: '2024-11-28',
      doctor: 'Dra. Ana Ruiz',
      status: 'available',
      category: 'Examen AudiolÃ³gico',
      description: 'EvaluaciÃ³n de la discriminaciÃ³n del habla',
      summary: 'Umbral de recepciÃ³n del habla (SRT) en 15 dB bilateral. DiscriminaciÃ³n del habla 100% a 45 dB en ambos oÃ­dos. Curva de inteligibilidad normal.'
    },
    {
      id: '5',
      type: 'AudiologÃ­a',
      ...
      status: 'pending',
      category: 'Examen AudiolÃ³gico',
      description: 'EvaluaciÃ³n de la vÃ­a auditiva central'
    }
  ];
  ...
  const authorizations = [
    ...
    {
      id: '2',
      procedure: 'Terapia de RehabilitaciÃ³n Auditiva',
      status: 'pending',
      date: '2024-12-16',
      eps: 'Nueva EPS',
    ...
    {
      id: '3',
      procedure: 'EcografÃ­a Abdominal',
      status: 'approved',
      date: '2024-12-10',
  ...
  const certificates = [
    {
      id: '1',
      type: 'Certificado de AfiliaciÃ³n EPS',
  ...
  const getAuthorizationBadge = (status: string) => {
    switch (status) {
      ...
      case 'pending':
        return <Badge className="bg-amber-100 text-amber-700 font-medium">En TrÃ¡mite</Badge>;
      case 'denied':
          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">{selectedResult.type} â€¢ {selectedResult.category}</p>
          ...
          <CardContent className="space-y-4">
            ...
            {selectedResult.summary && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <h4 className="font-medium text-blue-800 mb-2">InterpretaciÃ³n:</h4>
              ...
              <Button 
                onClick={() => {
                  toast.success('Descargando resultado...', {
                    description: `El archivo ${selectedResult.name}.pdf se estÃ¡ descargando`
                  });
                }}
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-gray-600">
                <p className="font-medium mb-1">Documento MÃ©dico Protegido</p>
                <p>Este resultado estÃ¡ cifrado y protegido. Solo tÃº y tu mÃ©dico tratante pueden acceder a esta informaciÃ³n.</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <TabsContent value="results" className="space-y-3">
          {filteredResults.length > 0 ? (
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600">{result.type} â€¢ {result.category}</p>
                      </div>
            ...
            <EmptyState
              ...
              description="Intenta ajustar los tÃ©rminos de bÃºsqueda o cambia de pestaÃ±a"
            />
          )}
        </TabsContent>
              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">CÃ³digo: {auth.code}</p>
                  </div>
