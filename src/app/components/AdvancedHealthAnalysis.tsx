...
export function AdvancedHealthAnalysis({ onBack, metrics }: AdvancedHealthAnalysisProps) {
  ...
  const metricAnalysis = [
    ...
    },
    {
      ...
      status: metrics.sleep >= 7 ? 'Ã“ptimo' : metrics.sleep >= 6 ? 'Aceptable' : 'Insuficiente',
      color: metrics.sleep >= 7 ? 'text-green-600' : metrics.sleep >= 6 ? 'text-yellow-600' : 'text-red-600',
      bgColor: 'bg-purple-50',
      iconColor: 'text-purple-600'
    },
    {
      name: 'Balance CalÃ³rico',
      icon: Zap,
  ...
  const insights = [
    {
      id: 'activity',
      title: 'PatrÃ³n de Actividad',
      description: metrics.steps >= 8000 ? 
        'Mantienes un excelente nivel de actividad fÃ­sica diaria.' :
        'Tu nivel de actividad fÃ­sica podrÃ­a mejorar para alcanzar los beneficios Ã³ptimos para la salud.',
    ...
    },
    {
      ...
      description: metrics.sleep >= 7 ?
        'Tu patrÃ³n de sueÃ±o favorece una buena recuperaciÃ³n.' :
        'Un sueÃ±o mÃ¡s prolongado mejorarÃ­a significativamente tu recuperaciÃ³n.',
    ...
    },
    {
      ...
      description: `Con una puntuaciÃ³n de ${healthAnalysis.overallScore}/100, tu estado de salud ${healthAnalysis.overallScore >= 75 ? 'es excelente' : healthAnalysis.overallScore >= 50 ? 'es bueno' : 'necesita atenciÃ³n'}.`,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
      ...
      <div className="flex items-center justify-between mb-6 pt-4">
        ...
        <div className="text-center">
          <h1 className="text-xl font-medium text-gray-900">AnÃ¡lisis Avanzado de Salud</h1>
          <p className="text-sm text-gray-600">Inteligencia Artificial Â· Integra IPS</p>
        </div>
            ...
            <div className={`bg-gradient-to-r ${getScoreGradient(healthAnalysis.overallScore)} p-6 text-white`}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-blue-100">PuntuaciÃ³n de Salud IA</p>
                </div>
                        ...
                        {isSelected && (
                          <div className="mt-3 pt-3 border-t border-gray-200">
                            <p className="text-xs text-gray-600">
                              <strong>Basado en IA:</strong> Este insight se genera analizando patrones en tus mÃ©tricas 
                              de salud y comparÃ¡ndolos con estÃ¡ndares mÃ©dicos establecidos.
                            </p>
                          </div>
                        )}
                      </div>
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-medium">PrÃ³ximos Pasos</h3>
            </div>
            <p className="text-blue-100 mb-4">
              ContinÃºa monitoreando tus mÃ©tricas diariamente. El anÃ¡lisis de IA se actualiza 
              automÃ¡ticamente con nuevos datos para brindarte insights mÃ¡s precisos.
            </p>
            <Button 
              variant="secondary" 
