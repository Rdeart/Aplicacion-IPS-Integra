      ...
      >
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden max-h-[90vh] overflow-y-auto">
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 px-6 py-5 relative">
            ...
            <h2 className="text-white text-xl font-semibold pr-10">Resultado MÃ©dico</h2>
          </div>
          ...
          <div className="p-6 space-y-5">
            ...
            {result.doctor && (
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-xs text-gray-500 font-medium">MÃ©dico Solicitante</p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-4">
              <h4 className="text-sm font-semibold text-gray-900 mb-2">DescripciÃ³n</h4>
              <p className="text-sm text-gray-700 leading-relaxed">
                {result.description || 'Examen de ' + result.name + ' realizado en Centro MÃ©dico Integra IPS. Los resultados han sido procesados y estÃ¡n disponibles para su revisiÃ³n.'}
              </p>
            </div>
