...
export function ProfileScreen({ user, onLogout }: ProfileScreenProps) {
  ...
  const userProfile = {
    ...
    address: currentUser?.address || 'Calle 123 #45-67, BogotÃ¡',
    ...
    chronicConditions: currentUser?.chronicConditions || ['HipertensiÃ³n']
  };
    ...
    <div className="bg-gray-50 overflow-x-hidden min-h-screen pb-4">
      <div className="px-5 pt-4 space-y-4">
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-gray-700 px-1">ConfiguraciÃ³n y Notificaciones</h3>
          <Card className="bg-white border-0">
            <CardContent className="p-0">
              ...
              <div className="p-5">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-gray-900 font-medium leading-snug">Alertas EpidemiolÃ³gicas</p>
                    <p className="text-sm text-gray-600 leading-snug mt-0.5">Alertas de salud pÃºblica</p>
                  </div>
                  <Switch
          ...
          <Card className="bg-white border-0">
            <CardContent className="p-0">
              ...
              <ListItem
                ...
                subtitle="Control de tu informaciÃ³n"
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-semibold text-gray-700 px-1">GestiÃ³n de Datos</h3>
          <Card className="bg-white border-0">
            <CardContent className="p-0">
              <ListItem
                icon={Download}
                iconColor="text-blue-500"
                iconBg="bg-blue-50"
                title="Descargar Historia ClÃ­nica"
              ...
              <ListItem
                ...
                iconColor="text-green-500"
                iconBg="bg-green-50"
                title="Compartir Perfil MÃ©dico"
                subtitle="Genera cÃ³digo QR temporal"
              ...
              <ListItem
                ...
                subtitle="Lee nuestras polÃ­ticas"
