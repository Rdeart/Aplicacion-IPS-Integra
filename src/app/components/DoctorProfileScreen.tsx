            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <Badge className="bg-blue-50 text-blue-700 border-0">
                  {doctor.yearsExperience} aÃ±os de experiencia
                </Badge>
              </div>
            </div>
          </div>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardContent className="p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-semibold text-gray-900 mb-1">UbicaciÃ³n</h4>
        ...
        <Card className="bg-white border-0 shadow-sm">
          <CardContent className="p-5">
            <h3 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
              ...
              Certificaciones y FormaciÃ³n Especial
            </h3>
            <div className="space-y-2">
        ...
        <Card className="bg-blue-50 border-0">
          <CardContent className="p-5">
            ...
            <p className="text-sm text-blue-800">
              Para agendar una cita o solicitar mÃ¡s informaciÃ³n, puedes contactarnos 
              directamente o usar nuestro sistema de agendamiento en lÃ­nea.
            </p>
          </CardContent>
        </Card>
      </div>
