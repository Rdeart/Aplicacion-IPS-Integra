                ...
                <div className="divide-y divide-gray-100">
                  {notifications.map((notification, index) => (
                    <motion.button
                      ...
                      aria-label={`${notification.read ? '' : 'No leÃ­da: '}${notification.message}`}
                    >
                      <div
                        role="button"
                        tabIndex={0}
                        ...
                        aria-label={`Eliminar notificaciÃ³n: ${notification.message}`}
                      >
                      ...
                      <div className="flex items-start gap-3 pr-8">
                        ...
                        {!notification.read && (
                          <div className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0 mt-2" aria-label="No leÃ­da" role="status"></div>
                        )}
                      </div>
                    </motion.button>
                  ))}
