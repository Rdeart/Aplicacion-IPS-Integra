...
export function EpidemiologicalAnalysisScreen({ onBack }: EpidemiologicalAnalysisScreenProps) {
  ...
  // Datos del mapa de calor simulado (por localidades de BogotÃ¡)
  const heatMapData = [
    ...
    { zona: 'EngativÃ¡', casos: 62, riesgo: 'medio', coordenadas: { lat: 4.7540, lng: -74.1166 } },
    { zona: 'Bosa', casos: 58, riesgo: 'medio', coordenadas: { lat: 4.6186, lng: -74.1928 } },
    { zona: 'Ciudad BolÃ­var', casos: 54, riesgo: 'medio', coordenadas: { lat: 4.5736, lng: -74.1719 } },
    { zona: 'FontibÃ³n', casos: 43, riesgo: 'bajo', coordenadas: { lat: 4.6697, lng: -74.1403 } },
    { zona: 'UsaquÃ©n', casos: 41, riesgo: 'bajo', coordenadas: { lat: 4.7049, lng: -74.0308 } },
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-orange-50 p-6 overflow-x-hidden">
      ...
      <div className="flex items-center justify-between mb-6 pt-4">
        ...
        <div className="text-center">
          <h1 className="text-xl font-medium text-gray-900">AnÃ¡lisis de Vigilancia EpidemiolÃ³gica</h1>
          <p className="text-sm text-gray-600">Dengue Â· Colombia Â· Agosto 2024</p>
        </div>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Tabs defaultValue="trends" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="geographic">GeogrÃ¡fico</TabsTrigger>
          </TabsList>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Casos por Semana - Ãšltimas 8 Semanas
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Tendencia Mensual con ProyecciÃ³n
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
          ...
          <TabsContent value="demographics" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>DistribuciÃ³n por Grupos de Edad</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>AnÃ¡lisis DemogrÃ¡fico</CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    {ageGroupData.map((group, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          ></div>
                          <span className="font-medium">{group.grupo} aÃ±os</span>
                        </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-800">
                          Mayor incidencia en adultos jÃ³venes (19-35 aÃ±os), seguido por el grupo de 36-60 aÃ±os. 
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  DistribuciÃ³n GeogrÃ¡fica por Localidades
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div className="bg-gradient-to-br from-blue-100 to-green-100 rounded-lg p-6 min-h-[300px] relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-lg font-medium text-gray-800 mb-4">Mapa de Intensidad - BogotÃ¡ D.C.</h3>
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-medium">Recomendaciones de Salud PÃºblica</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-blue-100">
              <div>
                <h4 className="font-medium text-white mb-2">Para la Comunidad:</h4>
                <ul className="space-y-1 text-sm">
                  <li>â€¢ Eliminar criaderos de mosquitos en recipientes con agua</li>
                  <li>â€¢ Usar repelente y ropa de manga larga</li>
                  <li>â€¢ Consultar inmediatamente ante sÃ­ntomas de fiebre</li>
                </ul>
              </div>
              <div>
                <h4 className="font-medium text-white mb-2">Para el Personal de Salud:</h4>
                <ul className="space-y-1 text-sm">
                  <li>â€¢ Intensificar vigilancia en zonas de alto riesgo</li>
                  <li>â€¢ Fortalecer diagnÃ³stico temprano</li>
                  <li>â€¢ Reportar casos sospechosos inmediatamente</li>
                </ul>
              </div>
            </div>
            <Button 
