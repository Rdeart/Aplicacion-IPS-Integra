      ...
      <div className="p-4 -mt-8">
        ...
        <Card className="mt-4">
          <CardContent className="p-4">
            <h3 className="text-gray-900 mb-3">ArtÃ­culos relacionados</h3>
            <div className="space-y-3">
              <div className="flex gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Hace 2 dÃ­as</p>
                </div>
              </div>
              <div className="flex gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-900 line-clamp-2">
                    Beneficios de mantener tus vacunas al dÃ­a
                  </p>
                  <p className="text-xs text-gray-500 mt-1">Hace 5 dÃ­as</p>
                </div>
              </div>
            </div>
          </CardContent>
