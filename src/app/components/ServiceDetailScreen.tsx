  ...
  return (
    ...
    >
      ...
      <Card className="bg-white border-gray-200 shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">DescripciÃ³n del Servicio</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="bg-white border-gray-200 shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">Â¿CuÃ¡ndo acudir?</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-gray-600 mb-3">
            Consulta este servicio si presentas alguno de estos sÃ­ntomas o situaciones:
          </p>
      ...
      <Card className="bg-white border-gray-200 shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">Â¿QuÃ© incluye la atenciÃ³n?</CardTitle>
        </CardHeader>
        <CardContent>
          <ul className="space-y-2">
      ...
      <Card className="bg-white border-gray-200 shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">Â¿Tienes preguntas?</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <p className="text-sm text-gray-600 mb-3">
      ...
      <Card className="bg-gray-50 border-gray-200 shadow-sm">
        <CardContent className="p-4 space-y-3">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            <p>
              <span className="font-medium">DirecciÃ³n:</span><br />
              Calle 100 #15-20, BogotÃ¡, Colombia
            </p>
            <p>
              <span className="font-medium">TelÃ©fono:</span><br />
              +57 (1) 234 5678
            </p>
            <p>
