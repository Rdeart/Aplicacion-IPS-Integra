...
export const NotificationDetailModal: React.FC<NotificationDetailModalProps> = ({ notification, onClose }) => {
  ...
  const renderResultContent = () => {
    ...
    const resultData = {
      '1': {
        ...
        description: 'Conteo completo de cÃ©lulas sanguÃ­neas',
        results: {
          ...
          'Leucocitos': { value: '7.200', reference: '4.500-11.000', unit: '/Î¼L', status: 'normal' },
          'Plaquetas': { value: '285.000', reference: '150.000-450.000', unit: '/Î¼L', status: 'normal' }
        }
      },
      '3': {
        ...
        description: 'EvaluaciÃ³n de lÃ­pidos en sangre',
        results: {
          ...
          'TriglicÃ©ridos': { value: '75', reference: '<150', unit: 'mg/dL', status: 'normal' }
        }
      }
    };
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="p-3 bg-gray-50 rounded-lg">
            <p className="text-xs text-gray-600">MÃ©dico tratante</p>
        ...
        <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
          <div className="flex items-start gap-2 text-sm text-gray-600">
            ...
            <p>Estos resultados son preliminares. Consulta con tu mÃ©dico tratante para una interpretaciÃ³n completa.</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-start gap-3 p-4 bg-purple-50 rounded-lg border border-purple-200">
          ...
          <div>
            <h3 className="text-purple-900">Cita MÃ©dica Confirmada</h3>
        ...
        <div className="space-y-3">
          <div className="p-3 bg-gray-50 rounded-lg">
            <p className="text-xs text-gray-600">MÃ©dico</p>
          ...
          <div className="p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">Calle 45 # 23-67, BogotÃ¡</p>
          </div>
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-start gap-3 p-4 bg-green-50 rounded-lg border border-green-200">
          ...
          <div>
            <h3 className="text-green-900">AutorizaciÃ³n Aprobada</h3>
        ...
        <div className="space-y-3">
          <div className="p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-900 mt-1">Consulta Especializada - CardiologÃ­a</p>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-600">CÃ³digo de autorizaciÃ³n</p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-600">Fecha de autorizaciÃ³n</p>
              <p className="text-gray-900 mt-1">18 Dic 2024</p>
            </div>
            <div className="p-3 bg-gray-50 rounded-lg">
              <p className="text-xs text-gray-600">VÃ¡lida hasta</p>
        ...
        <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-start gap-2 text-sm text-blue-900">
            ...
            <p>Esta autorizaciÃ³n es vÃ¡lida por 30 dÃ­as. Programa tu cita antes de que expire.</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-900 mt-1">LosartÃ¡n 50mg</p>
          </div>
          ...
          <div className="p-3 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-900 mt-1">Tomar con el estÃ³mago vacÃ­o, 1 hora antes de las comidas</p>
          </div>
        ...
        <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-start gap-2 text-sm text-blue-900">
            <AlertCircle className="h-4 w-4 mt-0.5 flex-shrink-0 text-blue-600" />
            <p>No olvides tomar tu medicamento a la misma hora todos los dÃ­as para mejores resultados.</p>
          </div>
        </div>
  ...
  const getTitle = () => {
    switch (notification.type) {
      case 'result':
        return 'Resultado MÃ©dico';
      case 'appointment':
        return 'Cita MÃ©dica';
      case 'authorization':
        return 'AutorizaciÃ³n EPS';
      case 'reminder':
        return 'Recordatorio';
      default:
