...
export function HeartRateDetailScreen({ onBack }: HeartRateDetailScreenProps) {
  ...
  const weeklyHeartRateData = [
    ...
    { day: 'MiÃ©', promedio: 75, maximo: 115, minimo: 58 },
    { day: 'Jue', promedio: 85, maximo: 142, minimo: 67 },
    { day: 'Vie', promedio: 80, maximo: 128, minimo: 63 },
    { day: 'SÃ¡b', promedio: 73, maximo: 108, minimo: 60 },
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white p-6 overflow-x-hidden">
      ...
      <div className="flex items-center justify-between mb-6 pt-4">
        ...
        <div className="flex items-center text-red-600">
          ...
          <h1 className="text-xl font-medium">Ritmo CardÃ­aco</h1>
        </div>
      ...
      <div className="max-w-4xl mx-auto mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card className="bg-orange-50 border-orange-200">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-sm text-orange-600">bpm mÃ¡ximo</p>
            </CardContent>
          </Card>
        ...
        <Card className="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-green-900">Tu ritmo cardÃ­aco estÃ¡ normal</h3>
                <p className="text-sm text-green-700">
                  MantÃ©n tu actividad fÃ­sica regular para un corazÃ³n saludable.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Tabs defaultValue="today" className="w-full">
          ...
          <TabsContent value="today" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Tiempo en zonas cardÃ­acas</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="week" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Ritmo cardÃ­aco esta semana</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
          ...
          <TabsContent value="zones" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>DistribuciÃ³n de zonas cardÃ­acas</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <p className="text-sm text-green-700">RecuperaciÃ³n activa y mejora del metabolismo bÃ¡sico.</p>
                  </div>
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <h4 className="font-medium text-blue-900 mb-2">Zona Ligera (70-85 bpm)</h4>
                    <p className="text-sm text-blue-700">Quema de grasas y mejora de la resistencia bÃ¡sica.</p>
                  </div>
                  <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                    <h4 className="font-medium text-orange-900 mb-2">Zona Moderada (85-100 bpm)</h4>
                    <p className="text-sm text-orange-700">Mejora cardiovascular y quema eficiente de calorÃ­as.</p>
                  </div>
                  <div className="p-4 bg-red-50 rounded-lg border border-red-200">
                    <h4 className="font-medium text-red-900 mb-2">Zona Intensa (100+ bpm)</h4>
                    <p className="text-sm text-red-700">Desarrollo de potencia anaerÃ³bica y velocidad.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="trends" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Tendencia del ritmo cardÃ­aco en reposo</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="mt-4 p-4 bg-green-50 rounded-lg">
                  <h4 className="font-medium text-green-900 mb-2">Tendencia positiva ðŸ“ˆ</h4>
                  <p className="text-sm text-green-700">
                    Tu ritmo cardÃ­aco en reposo ha mejorado un 8% en las Ãºltimas 6 semanas. 
                    Esto indica una mejora en tu condiciÃ³n cardiovascular.
                  </p>
                </div>
              </CardContent>
            </Card>
