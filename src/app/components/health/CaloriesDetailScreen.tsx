...
export function CaloriesDetailScreen({ onBack }: CaloriesDetailScreenProps) {
  ...
  const weeklyCaloriesData = [
    ...
    { day: 'MiÃ©', burned: 1980, consumed: 1750, net: 230 },
    { day: 'Jue', burned: 2420, consumed: 2100, net: 320 },
    { day: 'Vie', burned: 2180, consumed: 1900, net: 280 },
    { day: 'SÃ¡b', burned: 2650, consumed: 2200, net: 450 },
  ...
  const foodBreakdown = [
    ...
    { meal: 'Media maÃ±ana', calories: 100, color: '#84CC16', time: '10:00' },
  ...
  const nutritionBreakdown = [
    ...
    { nutrient: 'ProteÃ­nas', grams: 85, calories: 340, percentage: 21, color: '#10B981' },
  ...
  const getCalorieBalance = () => {
    ...
    return {
      value: balance,
      status: balance > 0 ? 'DÃ©ficit' : 'SuperÃ¡vit',
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white p-6 overflow-x-hidden">
      ...
      <div className="flex items-center justify-between mb-6 pt-4">
        ...
        <div className="flex items-center text-orange-600">
          ...
          <h1 className="text-xl font-medium">CalorÃ­as</h1>
        </div>
      ...
      <div className="max-w-4xl mx-auto mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-orange-900">
                  Balance calÃ³rico: {calorieBalance.status} de {Math.abs(calorieBalance.value)} kcal
                </h3>
                <p className="text-sm text-orange-700">
                  {calorieBalance.value > 0 
                    ? 'Â¡Excelente! EstÃ¡s quemando mÃ¡s calorÃ­as de las que consumes.'
                    : 'Considera aumentar tu actividad fÃ­sica o reducir el consumo calÃ³rico.'
                  }
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-700 font-medium">CalorÃ­as quemadas</span>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-700 font-medium">CalorÃ­as consumidas</span>
        ...
        <Tabs defaultValue="today" className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-6">
            ...
            <TabsTrigger value="nutrition">NutriciÃ³n</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="week" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Balance calÃ³rico semanal</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
          ...
          <TabsContent value="breakdown" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>CalorÃ­as quemadas por actividad</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      <Tooltip 
                        formatter={(value: any) => [`${value} kcal`, 'CalorÃ­as']}
                      />
                    </PieChart>
                  </ResponsiveContainer>
                </div>
          ...
          <TabsContent value="nutrition" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>DistribuciÃ³n de macronutrientes</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <p className="text-sm text-blue-700">Principal fuente de energÃ­a. Prefiere carbohidratos complejos.</p>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    <h4 className="font-medium text-green-900 mb-2">ProteÃ­nas (10-35%)</h4>
                    <p className="text-sm text-green-700">Esenciales para reparaciÃ³n muscular y saciedad.</p>
                  </div>
                  <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                    <h4 className="font-medium text-orange-900 mb-2">Grasas (20-35%)</h4>
                    <p className="text-sm text-orange-700">Importantes para absorciÃ³n de vitaminas. Prefiere grasas saludables.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
