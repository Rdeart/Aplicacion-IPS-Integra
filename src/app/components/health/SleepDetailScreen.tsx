...
export function SleepDetailScreen({ onBack }: SleepDetailScreenProps) {
  ...
  const weeklySleepData = [
    ...
    { day: 'MiÃ©', duration: 6.8, quality: 78, bedtime: '23:30', waketime: '06:45' },
    { day: 'Jue', duration: 7.8, quality: 88, bedtime: '22:00', waketime: '06:15' },
    { day: 'Vie', duration: 6.5, quality: 72, bedtime: '23:45', waketime: '06:30' },
    { day: 'SÃ¡b', duration: 8.5, quality: 95, bedtime: '22:30', waketime: '07:30' },
    { day: 'Dom', duration: 7.5, quality: 89, bedtime: '22:00', waketime: '06:00' }
  ];

  const sleepDistributionData = [
    { phase: 'SueÃ±o ligero', percentage: 45, duration: '3h 22m', color: '#3B82F6' },
    { phase: 'SueÃ±o profundo', percentage: 25, duration: '1h 52m', color: '#1E40AF' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white p-6 overflow-x-hidden">
      ...
      <div className="flex items-center justify-between mb-6 pt-4">
        ...
        <div className="flex items-center text-purple-600">
          ...
          <h1 className="text-xl font-medium">SueÃ±o</h1>
        </div>
      ...
      <div className="max-w-4xl mx-auto mb-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card className="bg-purple-50 border-purple-200">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-sm text-purple-600">DuraciÃ³n</p>
            </CardContent>
          </Card>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-medium text-purple-900">
                  Calidad del sueÃ±o: {qualityStatus.status}
                </h3>
                <p className="text-sm text-purple-700">
                  {currentQuality >= 80 
                    ? 'Tuviste una noche de sueÃ±o reparador. Â¡Sigue asÃ­!' 
        ...
        <Tabs defaultValue="today" className="w-full">
          ...
          <TabsContent value="week" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>DuraciÃ³n del sueÃ±o esta semana</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={weeklySleepData}>
                      ...
                      <YAxis />
                      <Tooltip 
                        formatter={(value: any) => [`${value}h`, 'DuraciÃ³n']}
                      />
                      <Bar 
                        dataKey="duration" 
                        fill="#8B5CF6" 
            ...
            <Card>
              <CardHeader>
                <CardTitle>Calidad del sueÃ±o esta semana</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Horarios de sueÃ±o</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  {weeklySleepData.map((day, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        <span className="text-purple-600">ðŸŒ™ {day.bedtime}</span>
                        <span className="text-orange-600">â˜€ï¸ {day.waketime}</span>
          ...
          <TabsContent value="phases" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>DistribuciÃ³n de fases del sueÃ±o</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Â¿QuÃ© significan las fases?</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <h4 className="font-medium text-blue-900 mb-2">SueÃ±o Ligero</h4>
                    <p className="text-sm text-blue-700">TransiciÃ³n hacia el sueÃ±o profundo. FÃ¡cil despertar.</p>
                  </div>
                  <div className="p-4 bg-indigo-50 rounded-lg border border-indigo-200">
                    <h4 className="font-medium text-indigo-900 mb-2">SueÃ±o Profundo</h4>
                    <p className="text-sm text-indigo-700">ReparaciÃ³n fÃ­sica y consolidaciÃ³n de memoria.</p>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <h4 className="font-medium text-purple-900 mb-2">REM</h4>
                    <p className="text-sm text-purple-700">SueÃ±os vÃ­vidos y procesamiento emocional.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="trends" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Tendencias del sueÃ±o</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card>
              <CardHeader>
                <CardTitle>AnÃ¡lisis de tendencias</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    <h4 className="font-medium text-green-900 mb-2">Mejora en calidad ðŸ“ˆ</h4>
                    <p className="text-sm text-green-700">
                      Tu calidad de sueÃ±o ha mejorado un 14% en las Ãºltimas 6 semanas.
                    </p>
                  </div>
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <h4 className="font-medium text-blue-900 mb-2">DuraciÃ³n estable â°</h4>
                    <p className="text-sm text-blue-700">
                      Mantienes un promedio constante de 7.3 horas de sueÃ±o por noche.
                    </p>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <h4 className="font-medium text-purple-900 mb-2">RecomendaciÃ³n ðŸ’¡</h4>
                    <p className="text-sm text-purple-700">
                      Intenta mantener horarios regulares para optimizar aÃºn mÃ¡s tu descanso.
                    </p>
                  </div>
                </div>
              </CardContent>
