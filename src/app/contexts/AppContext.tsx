...
export const AppProvider: React.FC<AppProviderProps> = ({ children }) => {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    ...
    },
    {
      id: '2',
      type: 'authorization',
      message: 'AutorizaciÃ³n EPS aprobada para Implante Coclear',
      time: 'Hace 1 dÃ­a',
      read: false,
      actionData: {
        screen: 'results',
    ...
    },
    {
      id: '3',
      type: 'result',
      message: 'Resultados de AudiometrÃ­a Tonal disponibles',
      time: 'Hace 2 dÃ­as',
      read: false,
      actionData: {
        screen: 'results',
    ...
    },
    {
      id: '4',
      type: 'result',
      message: 'Resultados de VideonistagmografÃ­a disponibles',
      time: 'Hace 3 dÃ­as',
      read: false,
      actionData: {
        screen: 'results',
